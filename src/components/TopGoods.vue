            ...
            <div class="boxs-top clearfix">
                ...
                <a href="//www.mi.com/smart/" target="_blank">
                    <span class="top-sub">
                        查看全部
                        <i
                            class="sub-icon fa fa-fw fa-chevron-circle-right"
                        ></i>
                    </span>
                </a>
            </div>
            <div class="boxs-content clearfix">
                <div class="box-left">
                    <a href="http://www.mi.com/scooter/" target="_blank">
                        <img
                            src="http://i3.mifile.cn/a4/124d82cc-cfce-44ab-b711-28b21be81683"
                            alt=""
                        />
                    </a>
                </div>
                    ...
                    <ul class="box-list">
                        ...
                        >
                            ...
                            <p class="box-price">
                                {{ good.price }}元
                                <template
                                    v-if="good.discountType === 'discount'"
                                >
