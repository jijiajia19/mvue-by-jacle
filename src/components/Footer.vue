        ...
        <div class="f1">
            <ul class="service clearfix">
                <li class="service-item">
                    <a
                        href="//www.mi.com/service/exchange#repaire"
                        target="_blank"
                    >
                ...
                <li class="service-item">
                    <a
                        href="//www.mi.com/service/exchange#back"
                        target="_blank"
                    >
                ...
                <li class="service-item">
                    <a
                        href="//www.mi.com/service/exchange#free"
                        target="_blank"
                    >
                        <span class="icon"><i class="fa fa-history"></i></span>
                        15天免费换货
                ...
                <li class="service-item">
                    <a
                        href="//www.mi.com/service/exchange#mail"
                        target="_blank"
                    >
            ...
            <ul class="footer-content clearfix">
                <li class="footer-item">
                    <article class="col-links">
                        ...
                        <p>
                            <a
                                href="//www.mi.com/service/account/register/"
                                target="_blank"
                                >账户管理</a
                            >
                        </p>
                        <p>
                            <a
                                href="//www.mi.com/service/buy/buytime/"
                                target="_blank"
                                >购物指南</a
                            >
                        </p>
                ...
                <li class="footer-item">
                    <article class="col-links">
                        ...
                        <p>
                            <a href="http://fuwu.mi.com/" target="_blank"
                                >自助服务</a
                            >
                        </p>
                        <p>
                            <a href="http://xiazai.mi.com/" target="_blank"
                                >相关下载</a
                            >
                        </p>
                    </article>
                ...
                <li class="footer-item">
                    <article class="col-links">
                        <h3>关于小米</h3>
                        <p>
                            <a href="//www.mi.com/about" target="_blank"
                                >了解小米</a
                            >
                        </p>
                        <p>
                            <a href="http://hr.xiaomi.com/" target="_blank"
                                >加入小米</a
                            >
                        </p>
                        <p>
                ...
                <li class="footer-item">
                    <article class="col-links">
                        ...
                        <p>
                            <a
                                href="http://e.weibo.com/xiaomishouji"
                                target="_blank"
                                >新浪微博</a
                            >
                        </p>
                ...
                <li class="footer-item">
                    <article class="col-links">
                        ...
                        <p>
                            <a
                                href="//order.mi.com/queue/f2code"
                                target="_blank"
                                >F码通道</a
                            >
                        </p>
                        ...
                        <p>
                            <a
                                href="//order.mi.com/misc/checkitem"
                                target="_blank"
                                >防伪查询</a
                            >
                        </p>
        ...
        <div class="f3 clearfix">
            ...
            <div class="explan-content">
                <ul class="links clearfix">
                    ...
                    <li class="link-item">
                        <a
                            href="http://shop115048570.taobao.com"
                            target="_blank"
                            >小米淘宝直营店</a
                        >
                    </li>
                ...
                <p class="explan-txt clearfix">
                    ©<a href="//www.mi.com/index.html">mi.com</a>
            ...
            <p class="footer-desc">探索黑科技，小米为发烧而生</p>
        </div>
    </footer>
</template>
